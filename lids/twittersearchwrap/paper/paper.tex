...
receipt of a query four steps are performed. In the following we will illustrate
...
\begin{enumerate}
	...
	\newline
	An
example\footnote{\url{http://twitter.com/SenJohnMcCain/statuses/46619460060196865}}
for a single retrieved post is the following:\newline\texttt{\justify{"Arab
League calls for no-fly zone in \#Libya http://t.co/ZsLNIWa"}},\newline posted
by Twitter user \texttt{SenJohnMcCain}; geo coordinates\footnote{The original Twitter message posted by SenJohnMcCain was not geotagged} and the date the message has been posted are furthermore known.
...
\texttt{\justify{"Arab League calls for Libya no-fly zone-state TV
- CAIRO, March 12 (Reuters) - The Arab League on Saturday called on the U.N.
Security Council to impose a no-fly zone on Libya, Egyptian state television
reported, a decision that would give a regional seal of approval that NATO has
said is needed for any military action."}}
...
single input stream:\newline\texttt{\justify{"Arab
League calls for no-fly zone in \#Libya Arab League calls for Libya no-fly zone-state TV
- CAIRO, March 12 (Reuters) - The Arab League on Saturday called on the U.N.
Security Council to impose a no-fly zone on Libya, Egyptian state television
reported, a decision that would give a regional seal of approval that NATO has
said is needed for any military action."}}\newline This string is appended to
the Twitter content and the external content of all other posts in the result.
...
like Libya, Gaddafi or the Arab\_League.
    ...
    \texttt{\justify{<http://km.aifb.kit.edu/services/twittersearchwrap/searchwrap?q\newline=\%23lybia>
	...
	in the output document. Here, the description for the initially given post
	abbreviated \texttt{m} results in the following
	triples:\newline
	\texttt{\justify{<http://km.aifb.kit.edu/services/twitterwrap/statuses/show/4661\newline
	9460060196865\#id> foaf:page
	<http://twitter.com/SenJohnMcCain/\newline statuses/46619460060196865>
	;\newline dc:date "2011-03-12T17:12:00Z" ;\newline geo:lat "49.010239" ;\newline geo:long "8.411879" ;\newline foaf:maker
	<http://km.aifb.kit.edu/services/twitterwrap/users/\newline
	 show?screen\_name=SenJohnMcCain\#id> ;\newline dc:description "Arab League
	calls for no-fly zone in \#Libya http://\newline t.co/ZsLNIWa" . }}
...
The system generates and outputs an RDF document in RDF/XML Syntax containing a
...
The second query set consists of hash tags that are frequently used on Twitter.
