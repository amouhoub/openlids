...
\myremark{todo}{warum kein direktes Mapping auf dbpedia-Entitäten?}
...
\myremark{todo}{ergänzen: abkürzungen, verschmelzen von Wörtern}
...
\myremark{todo}{Wo ist das System zugreifbar?}
...
Topics trending worldwide and in Germany on Twitter retrieved on February 24th
...
We have sampled the Twitter message feed using Twitter's Streaming API for one minute twice an hour from 2011-03-03 to
2011-03-06.
The top-50 hashtags dervied from the aggregate sample are listed in Table \ref{tbl:hashtags}.
We then recorded search results for these 50 hashtags during the course of 24 hours (2011-03-07).
...
rt &      83 \\
mentionke &      61 \\
blackpeoplemovies &      57 \\
tigerblood &      56 \\
thataintwinning &      53 \\
fail &      53 \\
teamfollowback &      52 \\
iftwitterwashighschool &      51 \\
bieberfact &      51 \\
news &      46 \\
jobs &      45 \\
libya &      44 \\
...
imagine &      20 \\
nowwatching &      19 \\
cumannanyaindonesia &      19 \\
twexit &      18 \\
lcv &      18 \\
fui &      18 \\
bot &      18 \\
nemuritsuzuketeshinu &      17 \\
fato &      17 \\
\end{tabular}
...
\myremark{todo}{Deutsche Themen nicht ausgewertet wegen Sprachproblem}
...
\myremark{todo}{Nicht genau machbar wegen Zeitpunkt, wann Lookup gemacht werden soll, nicht bekannt}
\end{itemize}
\end{definition}
